...
class PhotoGalleryController extends Controller
{
    ...
    protected function detail($id)
    {
        ...
        $show->photos()->as(function () use ($id){
            return Photo::where('gallery_id', $id)->count();
        });
    ...
    protected function form()
    {
        ...
        })->tab("Photos", function (Form $form){
            return $form->hasMany('photos', function (Form\NestedForm $nestedForm){
                $nestedForm->image('photo_url', "Photo")
